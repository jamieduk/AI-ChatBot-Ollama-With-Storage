...
def extract_answer(response):
    # Use a regular expression to find the numerical answer in the response
...
if answer:
    ...
    # Extract the actual answer from the chain output
    final_answer=extract_answer(chain_output)
